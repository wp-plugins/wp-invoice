   ...
   */
    ...
    */
    function process_manual_event() {
      //check_admin_referer('wpi_process_manual_event_nonce');
      ...
      // Modify $event_note to be useful
      ...
      $invoice->add_entry("attribute=balance&note=$event_note&amount=$event_amount&type=$event_type&time=$timestamp");
      $invoice->save_invoice();
      
      $response = array(
        'message' => "Event Added: $event_note."
      );
