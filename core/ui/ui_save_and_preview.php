...
<?php endif; ?>
	...
	<table class="form-table">
		...
		<tr class="invoice_main">
			...
			<input name="wp_invoice_email_message_subject" style="width: 400px;" value="<?php echo preg_replace_callback('/(%([a-z_]+)%)/', 'wp_invoice_email_apply_variables', (!empty($invoice_class->email_message_subject) ? $invoice_class->email_message_subject : get_option('wp_invoice_email_send_invoice_subject'))); ?>" />
			</td>
		</tr>
