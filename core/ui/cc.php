<form method="post" name="checkout_form" id="checkout_form" class="online_payment_form" onsubmit="process_cc_checkout(); return false;" class="clearfix">
	...
	<?php } ?>
		...
		<?php 
		$zip_code_label_array = apply_filters('wp_invoice_zip_code_label', array("US" => "ZIP Code", "UK" => "Postal Code"));
		$zip_code_label = $zip_code_label_array[$invoice->user_class->wpi_localization];?>
		
		<?php echo $zip_code_label; ?></label>
