...
<div id="wp_invoice_settings_page" class="wp_invoice_tabbed_content"> 
  <ul class="wp_invoice_settings_tabs"> 
    ...
    <li><a href="#tab6"><?php _e("Shortcodes") ?></a></li> 
  ...
  <div id="tab1" class="wp_invoice_tab" >
		...
		<tr>
			...
			<?php echo wp_invoice_draw_select('wp_invoice_use_recurring',array("yes" => __("Yes", WP_INVOICE_TRANS_DOMAIN),"no" => __("No", WP_INVOICE_TRANS_DOMAIN)), get_option('wp_invoice_use_recurring')); ?>
				...
				<tr>
			<th><?php _e("Exclude IPs from Invoice Log:", WP_INVOICE_TRANS_DOMAIN) ?></th>
			<td>
			<?php echo wp_invoice_draw_textarea('wp_invoice_exclude_ips', get_option('wp_invoice_exclude_ips')); ?><br />
			<span class="description">Enter as many IP addresses as you want, one per line, and they will not be visible in your logs.</span>
			</td>
		</tr>
  ...
  <div id="tab2"  class="wp_invoice_tab">
		...
		<tr>
			<th width="200"><?php _e('Tax Label:', WP_INVOICE_TRANS_DOMAIN); ?></th><td>
			<?php echo wp_invoice_draw_inputfield('wp_invoice_custom_label_tax', get_option('wp_invoice_custom_label_tax')); ?>
			</td>
		</tr>			
		<tr>
			<th width="200"><?php _e('Zip Code Label:', WP_INVOICE_TRANS_DOMAIN); ?></th><td>
			<?php echo wp_invoice_draw_inputfield('wp_invoice_custom_zip_label', get_option('wp_invoice_custom_zip_label')); ?>
			</td>
		</tr>	
  ...
  <div id="tab3"  class="wp_invoice_tab">
	...
	<table class="form-table" >
		<tr>
			<td colspan="2">
			<h3>Invoice List</h3>
			<p>List all available invoices for currently logged in client.  This can also be done using the Invoice History widget.</p>
			<p> 
				<b>Basic Shortcode</b> -  <span class="wp_invoice_explanation"><?php echo '[wp-invoice-list]'; ?></span>
			</p>
			<p>
				You may also pass the due invoice and paid invoice titles via shortcode, example: <br />
				<span class="wp_invoice_explanation">[wp-invoice-list due_invoice_title="Pay These" paid_invoice_title="Already Paid"]</span>
			</p>
			<p>If you'd like to see more shortcode settings added, please suggest an idea on our <a href="http://wpinvoice.uservoice.com">UserVoice</a> site.
