...
<?php endif; ?>
	...
	<?php } ?>
		...
		<input type="image"  src="<?php echo get_option('wp_invoice_fe_paypal_link_url'); ?>" style="border:0; padding:0;" name="submit" alt="Make payments with PayPal - it's fast, free and secure!">
		</li>
