...
function wp_invoice_send_email($invoice_array,$reminder = false)
{
	...
	if(is_array($invoice_array)) 
	{
		...
		$message = strip_tags(wp_invoice_show_email($invoice_id,$reminder));
...
function wp_invoice_process_settings() {
	...
	if(isset($_POST['wp_invoice_reminder_message'])) update_option('wp_invoice_reminder_message', $_POST['wp_invoice_reminder_message']);
