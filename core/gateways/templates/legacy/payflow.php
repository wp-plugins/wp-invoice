<form method="POST" action="https://payflowlink.paypal.com">
    ...
    <fieldset id="credit_card_information">
        <ol>
            <li>
                <label for="NAME"><?php _e('Billing Name', WP_INVOICE_TRANS_DOMAIN); ?></label>
                <input name="NAME" type="text" id="NAME" value="<?php echo $invoice['user_data']['first_name'] . ' ' . $invoice['user_data']['last_name'];?>" />
            </li>
            <li>
                <label for="ADDRESS"><?php _e('Billing Address', WP_INVOICE_TRANS_DOMAIN); ?></label>
            ...
            switch ($wpi_settings['state_selection']) {
                case 'hide':
                    break;
                case 'dropdown':
                    echo '<li id="state_field"><label for="state">'.__('State', WP_INVOICE_TRANS_DOMAIN). '</label>';                
            ...
            <li>
                <label for="USER1"><?php _e('Your email', WP_INVOICE_TRANS_DOMAIN); ?></label>
