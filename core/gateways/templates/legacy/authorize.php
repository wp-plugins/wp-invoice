<form method="post" name="credit_card_checkout_form" id="credit_card_checkout_form" class="online_payment_form" onsubmit="validate_cc_checkout(); return false;" class="clearfix">
  ...
  <li>
    ...
    <button type="submit" id="cc_pay_button" class="hide_after_success submit_button">Process Payment of <?php echo $invoice['meta']['currency_symbol']  . WPI_Functions::money_format($invoice['amount']); ?></button>
