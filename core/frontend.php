...
#invoice_page {text-align: left; clear:both;display: block;}
#invoice_page #billing_overview #wp_invoice_select_payment_method {padding-bottom: 0px;margin-bottom:0;}
...
#invoice_page input {width: 230px; border:0; background: #EFEFEF; padding: 5px;  -moz-border-radius:9px;  border-radius: 9px; margin-bottom: 0;}
#invoice_page select {margin-bottom: 0;}
...
#invoice_page #billing_overview {width: 400px; float:right;}
...
#invoice_page.clearfix {display: block;}
