...
class WP_Invoice {
	...
	function WP_Invoice() {
		...
		add_action('admin_head-web-invoice_page_invoice_settings', array($this, 'admin_head_wpi_specific'));
		add_action('admin_head-toplevel_page_web-invoice_page_overview', array($this, 'admin_head_wpi_specific'));
		add_action('admin_head-web-invoice_page_new_invoice', array($this, 'admin_head_wpi_specific'));
