...
*/
	...
	define("WP_INVOICE_VERSION_NUM", "1.8.3");
...
class WP_Invoice_GetInfo {
	...
	case 'link':
		...
		//fix link if https is enforced
		if(get_option('wp_invoice_force_https') == 'true') {$link_to_page = str_replace('http://','https://',$link_to_page);}
