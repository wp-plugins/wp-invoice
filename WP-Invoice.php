...
*/
	...
	define("WP_INVOICE_VERSION_NUM", "1.8.2");
...
class WP_Invoice {
	   ...
	   function SetUserAccess($level = 8) {
		...
		wp_enqueue_script('jquery.maskedinput',$this->uri."/core/js/jquery.maskedinput.js", array('jquery'));
		wp_enqueue_script('jquery.form',$this->uri."/core/js/jquery.form.js", array('jquery') );
		if(is_admin()) {
			...
			wp_enqueue_script('wp-invoice',$this->uri."/core/js/wp-invoice-1.8.js", array('jquery') );
		} else {
