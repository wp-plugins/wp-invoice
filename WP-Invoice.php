...
define("WP_INVOICE_VERSION_NUM", "1.91");
...
class WP_Invoice {
	...
	function admin_head() {
		echo "<link rel='stylesheet' href='".$this->uri."/core/css/wp_admin-1.9.css' type='text/css'type='text/css' media='all' />";
	}
	...
	function init() {
		...
		if(is_admin()) {
			...
			wp_enqueue_script('wp-invoice',$this->uri."/core/js/wp-invoice-1.9.js", array('jquery') );
		} else {
