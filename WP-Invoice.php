...
define("WP_INVOICE_VERSION_NUM", "2.00");
...
class WP_Invoice {
	...
	function wp_invoice_add_pages() {
		...
		*/
		...
		add_meta_box('wp_invoice_metabox_billing', __('Billing Settings',WP_INVOICE_TRANS_DOMAIN), 'wp_invoice_metabox_billing', 'web-invoice_page_new_invoice', 'normal', 'normal');
