...
= New Features: =
* Finally - PayPal powered recurring invoices!
* Improved (autocompletion) user search for new invoice creation.
* Notification may be sent to new users.
* Customizable invoice welcome line.
* User Interface Improvements - toggable overview table columns, draggable metaboxes, etc.
* Two widgets added for invoice history and invoice lookup.
* Invoices with deleted users may be used as templates.
...
== Upgrade Notice ==
= 2.039  =
* One of the core filenames was changed, so after upgrading, be sure to visit the plugins page, and manually re-activate the plugin.
