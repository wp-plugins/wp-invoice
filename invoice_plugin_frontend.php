...
<input name="amount" type="hidden" value="<?php echo $amount; ?>">
<input name="user_id" type="hidden" id="invoice_num"  value="<?php echo  $user_id; ?>">
<input name="email_address" type="hidden" id="invoice_num"  value="<?php echo  $email_address; ?>">
<input name="invoice_num" type="hidden" id="invoice_num"  value="<?php echo  $invoice_id; ?>">
...
<ol>
	...
	<input name="address" id="streetaddress" class="input_field"  type="text"  size="40" maxlength="60" value="<?php print $streetaddress; ?>"> 
	</li>
